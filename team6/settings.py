...
# Azure OpenAI (DALL-E) 설정 Sweden Central
AZURE_DALLE_SC_ENDPOINT = env("AZURE_DALLE_SC_ENDPOINT")
AZURE_DALLE_SC_API_KEY = env("AZURE_DALLE_SC_API_KEY")
AZURE_DALLE_SC_API_VERSION = env("AZURE_DALLE_SC_API_VERSION")

# Azure OpenAI (DALL-E) 설정 Australia East
AZURE_DALLE_AE_ENDPOINT = env("AZURE_DALLE_AE_ENDPOINT")
AZURE_DALLE_AE_API_KEY = env("AZURE_DALLE_AE_API_KEY")
AZURE_DALLE_AE_API_VERSION = env("AZURE_DALLE_AE_API_VERSION")
...
BING_ENDPOINT = env("BING_ENDPOINT")
...
AZURE_OPENAI_BING_API_KEY = env("AZURE_OPENAI_BING_API_KEY")
AZURE_OPENAI_BING_ENDPOINT = env("AZURE_OPENAI_BING_ENDPOINT")
AZURE_OPENAI_BING_DEPLOYMENT_NAME = env("AZURE_OPENAI_BING_DEPLOYMENT_NAME")
